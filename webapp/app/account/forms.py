...
from app.models import User, LookupValue
...
class NewCollectionForm(FlaskForm):
  ...
  public = QuerySelectField("Allow collection to be seen by others?", allow_blank=True, query_factory=lambda: LookupValue.query.filter_by(group='bool'))
  submit = SubmitField('Create')
  

class EditCollectionForm(NewCollectionForm):
